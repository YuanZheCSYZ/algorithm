...
class Solution:
    """
    Runtime: 968 ms, faster than 5.09% of Python3 online submissions for Minimum Height Trees.
    Memory Usage: 118.8 MB, less than 5.04% of Python3 online submissions for Minimum Height Trees.
    """
    ...
    Memory Usage: 19 MB, less than 29.20% of Python3 online submissions for Minimum Height Trees.
